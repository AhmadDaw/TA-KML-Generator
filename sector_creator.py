...
def create_kml(data,output,names,g):
    ...
    for p in range(len(poly)):
        ...
        if (per_acc > 95 and per_acc <= 100):
            single.style.polystyle.color = '64140078' # red
        elif (per_acc > 75 and per_acc <= 95): 
            single.style.polystyle.color = '64F07800' # blue
        elif (per_acc > 50 and per_acc <= 75):
            single.style.polystyle.color = '643C8214' # dark green
        elif (per_acc > 25 and per_acc <= 50):
            single.style.polystyle.color = '6400E614' # light green 
        else:
            single.style.polystyle.color = '6414F0BE' # red
...
def create_sector_kml(data,x_field,y_field,angle,distance,std,g,points=36,name=None,output=None):
